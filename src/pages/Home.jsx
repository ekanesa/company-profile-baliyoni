    ...
    <div className="bg-white">
      ...
      <main className="relative isolate px-6 lg:px-8 ">
        ...
        <div className="mx-auto max-w-7xl py-32 sm:py-48 lg:py-56 px-6">
          ...
          <div className="relative mb-96 mt-80 bg-white flex flex-col md:flex-row items-center justify-center p-4 space-y-6 md:space-y-0">
          ...
          <div className="w-full bg-white flex justify-center items-center p-4 md:p-10">
            <div className="flex flex-col md:flex-row md:space-x-8 space-y-8 md:space-y-0">
              ...
              <div className="relative flex flex-col items-center">
                ...
                <div className="mt-12 w-[90vw] md:w-[400px] h-[350px] md:h-[300px] bg-black opacity-[81%] rounded-2xl p-6 shadow-xl flex flex-col">
          ...
          <div className="relative justify-center mt-24 px-4 overflow-hidden">
          ...
          <div className="relative overflow-hidden h-48 flex items-center justify-start bg-white mt-24">
            {/* Marquee Items (Animasi Latar) */}
            <div className="absolute left-0 top-1/2 transform -translate-y-1/2 flex animate-marquee whitespace-nowrap">
              <img
                className=" flex items-center justify-center mx-4 w-[96px] h-[96px]"
                src="../img/asus.png"
                alt=""
              />
              <img
              ...
              <img
                className=" flex items-center justify-center mx-4 w-[96px] h-[96px]"
                src="../img/panasonic.png"
                alt=""
              />
              <img
                className=" flex items-center justify-center mx-4 w-[96px] h-[96px]"
                src="../img/mitsubisi.png"
                alt=""
              />
            </div>

            {/* Duplikat untuk loop mulus */}
            <div className="absolute left-0 top-1/2 transform -translate-y-1/2 flex animate-marquee2 whitespace-nowrap">
              <img
                className=" flex items-center justify-center mx-4 w-[96px] h-[96px]"
                src="../img/asus.png"
                alt=""
            ...
            {/* Static Title in Center */}
            <div className="z-10 bg-white px-10 py-5 text-4xl font-bold">
              Our Partner
            </div>
          </div>

          {/* DIBAWAH ADALAH DIV TERAKHIR */}
        </div>
      </main>
    </div>
  );
