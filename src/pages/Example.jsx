    ...
    <div className="bg-white">
      ...
      <div className="relative isolate px-6 lg:px-8">
        ...
        {/* <div className="text-center">
            ...
            <p className="mt-4 text-2xl font-semibold text-pretty text-red-500 sm:text-3xl">
              One Stop Solution.
            </p>
            <p className="text-2xl font-semibold text-pretty text-red-500 sm:text-2xl">
        ...
        <div className="mx-auto max-w-7xl py-32 sm:py-48 lg:py-56 px-6">
          <div className="flex flex-col-reverse lg:flex-row items-center gap-12">
            ...
            <div className="flex-1">
              <img
                src="/img/bg1.png" // Pastikan file ini ada di public/img/
                alt="Baliyoni Logo"
